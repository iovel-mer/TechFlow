...
export const Hero: React.FC = () => {
  ...
  const CryptoLogo = ({ coin, size = 36 }: { coin: any; size?: number }) => {
    ...
    if (hasError || !logoSrc) {
      ...
      return (
        <div
          className={`flex items-center justify-center rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 text-white font-bold text-xs`}
  ...
  // Update the mockCryptoData to not rely on logo property
  ...
  return (
    <section className='min-h-screen bg-black text-white pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 relative overflow-hidden'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-start'>
          ...
          <div className='lg:col-span-5 space-y-4 sm:space-y-6 mt-8 lg:mt-0'>
            {/* Live Market Card */}
            <div className='bg-gray-900/30 border border-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 backdrop-blur-sm'>
              <div className='flex items-center justify-between mb-4 sm:mb-6'>
                <h3 className='text-lg sm:text-xl font-bold text-white'>Live Market</h3>
                    ...
                    .map((coin: any, index) => (
                      ...
                      >
                        <div className='flex items-center space-x-2 sm:space-x-3'>
                          <CryptoLogo coin={coin} size={window.innerWidth < 640 ? 32 : 36} />
                          <div>
